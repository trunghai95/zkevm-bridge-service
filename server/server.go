...
import (
	...
	sentinelPlugin "github.com/alibaba/sentinel-golang/pkg/adapters/grpc"
...
func runGRPCServer(ctx context.Context, bridgeServer pb.BridgeServiceServer, port string) error {
	...
	server := grpc.NewServer(grpc.UnaryInterceptor(sentinelPlugin.NewUnaryServerInterceptor()))
...
func preflightHandler(w http.ResponseWriter, r *http.Request) {
	headers := []string{"Content-Type", "Accept", "X-Locale", "X-Utc", "X-Zkdex-Env"}
