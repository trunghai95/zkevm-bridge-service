...
require (
	github.com/0xPolygonHermez/zkevm-node v0.0.8
...
replace github.com/0xPolygonHermez/zkevm-node => github.com/okx/zkevm-node v0.1.3-0.20230911084613-ac9ff35b4824
